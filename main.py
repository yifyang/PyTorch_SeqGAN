...
parser.add_argument('--g_pretrain_steps', type=int, default=250, metavar='N', # 50
...
parser.add_argument('--gk_epochs', type=int, default=1, metavar='N', # 3
...
NEGATIVE_FILE = 'gen_news_0429_n.data'
RANDOM_FILE = 'news_rand.data'
EPOCH_FILE = 'epoch_news_0429_n.data' # store samples every epoch during adversarial training
